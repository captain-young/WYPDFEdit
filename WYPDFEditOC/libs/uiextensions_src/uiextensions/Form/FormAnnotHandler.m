...
- (TbBaseBar*)buildFormNaviBar
{
    ...
    TbBaseItem *resetItem = [TbBaseItem createItemWithImageAndTitle:NSLocalizedString(@"kReset", nil) imageNormal:nil imageSelected:nil imageDisable:nil background:nil imageTextRelation:0];
    ...
    TbBaseItem *doneItem = [TbBaseItem createItemWithImageAndTitle:NSLocalizedString(@"kDone", nil) imageNormal:nil imageSelected:nil imageDisable:nil background:nil imageTextRelation:0];
...
-(BOOL)isHitAnnot:(FSAnnot*)annot point:(FSPointF*)point
{
    ...
    if(hitAnnot && ([[hitAnnot getUniqueID] isEqualToString:[annot getUniqueID]]))
    {
