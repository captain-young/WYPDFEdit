...
-(void)onAnnotSelected:(FSAnnot*)annot
{
    ...
    MenuItem *copyItem = [[MenuItem alloc] initWithTitle:NSLocalizedString(@"kCopyText", nil) object:self action:@selector(copyText)];
    MenuItem *editItem = [[MenuItem alloc] initWithTitle:NSLocalizedString(@"kEdit", nil) object:self action:@selector(edit)];
